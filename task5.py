...
for j in idxs_y:
  ...
  cv.putText(img_cnt,'Yellow',(x+10,y+10),color=(0,255,0),fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=3.0,thickness=10)
...
for j in idxs_b:
  ...
  x, y, w, h = cv.boundingRect(c)
  cv.rectangle(img_cnt, (x, y), (x+w, y+h), (0,255,0), 10)
  cv.putText(img_cnt,'Blue',(x+10,y+10),color=(0,255,0),fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=3.0,thickness=10)
...
for j in idxs_r:
  ...
  x, y, w, h = cv.boundingRect(c)
  cv.rectangle(img_cnt, (x, y), (x+w, y+h), (0,255,0), 10)
  cv.putText(img_cnt,'Red',(x+10,y+10),color=(0,255,0),fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=3.0,thickness=10)
